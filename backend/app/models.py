...
class ProjectInfo(BaseModel):
    ...
    name: str = "Pantheon Research — Gemini Hackathon Demo"
    description: str = (
        "Gemini-powered investment research overlay for human-in-the-loop "
        "financial decision intelligence, with Qwen and DeepSeek as secondary comparison models."
    )
    author: str = "Jacob Zhao"
    github: str = "https://github.com/0xjacobzhao-byte/pantheon-research-gemini-hackathon"
