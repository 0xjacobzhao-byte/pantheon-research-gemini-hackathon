...
|---|---|---|---|---|---|
| **Live product** | LIVE | [README § What Pantheon Is](../README.md#what-pantheon-research-is) | ✅ [pantheon-research.com](https://pantheon-research.com) | 🔒 private repo | Public surfaces are free; Pro delivery is controlled beta |
| **Seven-layer architecture** | LIVE | [README § Architecture](../README.md#architecture) · [architecture_diagram.md](architecture_diagram.md) | 🌐 dashboard | 🔒 private repo | Layer 7 (execution) is staged and fail-closed, not live |
...
| **Public/private repo split** | — | ✅ [README § Repository Scope](../README.md#repository-scope) | — | [`production_reference/`](../production_reference/) | Public repo is a sanitized slice, not the production codebase |
...
| Capability | Status | Public evidence | Live evidence | Representative source | Limitations |
|---|---|---|---|---|---|
| **Five-model stack** (Claude · ChatGPT · Gemini · DeepSeek · Qwen) | LIVE | [README § Five-Model AI](../README.md#deterministic-research--five-model-ai) | 🌐 AI Analyst Consensus | ✅ [`production_reference/overlayComparison.ts`](../production_reference/overlayComparison.ts) | Four providers pre-existed; **Gemini is the hackathon addition** |
...
| **Disagreement surfaced, not averaged** | LIVE | [README § Five-Model AI](../README.md#deterministic-research--five-model-ai) | 🌐 model-comparison panel | ✅ `overlayComparison.ts` — `MajorDivergence`, `AgreementSummary` | Divergence is a review trigger, not an error state |
...
| **Evidence-backed vs AI-prior separation** | LIVE | [README § Five-Model AI](../README.md#deterministic-research--five-model-ai) | 🌐 lane labels on overlays | ✅ [`production_reference/evidence_tier.py`](../production_reference/evidence_tier.py) | Five graded tiers; an AI prior can never present as source-backed |
...
| **Equity Decisions** | LIVE | [README § Current Maturity](../README.md#current-maturity) | 🌐 live product | 🔒 private repo | Research context; not investment advice |
| **AI Analyst Consensus** | LIVE (cache-only) | [README § Current Maturity](../README.md#current-maturity) | 🌐 live product | ✅ `overlayComparison.ts` | Cache-only — overlays are not regenerated per page view |
| **LLM Research Summary** | LIVE | [README § Current Maturity](../README.md#current-maturity) | 🌐 live product | ✅ `overlayComparison.ts` (summary contract) | Labelled by support level: evidence-backed / mixed / AI-prior |
...
| Capability | Status | Public evidence | Live evidence | Representative source | Limitations |
|---|---|---|---|---|---|
| **Signal / alert delivery** | INTERNAL (dry-run default) | [README § Current Maturity](../README.md#current-maturity) | — | ✅ [`production_reference/freshness_policy.py`](../production_reference/freshness_policy.py) (alert-module TTL registry) | Fail-closed; dry-run by default |
| **Telegram Agent** | BETA | [README § Current Maturity](../README.md#current-maturity) | 🌐 account linking in product | ✅ [`production_reference/advice_policy.py`](../production_reference/advice_policy.py) | Pro-gated per-user delivery; controlled beta |
| **Weekly automated reports** | BETA | [README § Current Maturity](../README.md#current-maturity) | 🌐 email delivery | 🔒 private repo | Controlled beta, fail-closed by default |
| **Advice vs execution boundary** | LIVE | ✅ [README § What AI Does](../README.md#what-ai-actually-does) | — | ✅ [`production_reference/advice_policy.py`](../production_reference/advice_policy.py) | Advice ALLOWED, execution NOT AUTHORIZED — enforced in code |
| **Human-in-the-loop boundary** | LIVE | ✅ [README § Safety](../README.md#safety--non-claims) · [safe_claims.md](safe_claims.md) | — | ✅ `advice_policy.py` · `valuation_outlier_review_service.py` | No order path, no broker credential, no signing key |
...
| **Forward validation** | LIVE | [validation_methodology.md](validation_methodology.md) · [README § Validation](../README.md#validation) | 🌐 validation surfaces | [`backend/app/validation_timeline.py`](../backend/app/validation_timeline.py) | Maturity varies by market; equities still accumulating samples |
| **Matured outcomes** | PARTIAL | [README § Validation](../README.md#validation) | 🌐 BTC track | 🔒 private repo | **No validated-alpha claim is made anywhere in this submission** |
...
| **Business model** | — | ✅ [README § Business Model](../README.md#business-model) · [business_model_and_pnl.md](business_model_and_pnl.md) | — | — | Projections are clearly separated from actuals |
...
| Capability | Status | Public evidence | Live evidence | Representative source | Limitations |
|---|---|---|---|---|---|
| **Primary production** (Vercel + Railway) | LIVE | [README § Deployment](../README.md#deployment-architecture) | ✅ [pantheon-research.com](https://pantheon-research.com) | 🔒 private repo | The **only** canonical writer |
